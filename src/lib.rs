...
#[derive(Debug)]
pub struct CloudNativeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CloudNativeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CloudNative processing");
    
    let mut processor = CloudNativeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CloudNativeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CloudNativeProcessor::new(false);
